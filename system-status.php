...
<body>
	...
	<?php if (!empty($getStatus)) { ?> 
        ...
        foreach ($getStatus as $key => $value) {?>
            <li style="margin-bottom: 20px;"><?php echo ($value["type"] == "error") ? '<strong style="color: red">Important!</strong>' : '<strong style="color: #b28e51">Warning:</strong>';?> <?php echo $value["message"];?></li>
    <?php }} else { ?>
