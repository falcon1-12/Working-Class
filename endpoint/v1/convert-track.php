...
if (in_array(true, $request)) {
   $errors[] = "Something went wrong Please try again later!";
	...
	$shell     = shell_exec("$ffmpeg_b -y -i $audio_file_full_path -filter_complex \"aformat=channel_layouts=mono,showwavespic=s=1100x150:colors=#b28e51\" -frames:v 1 $audio_output_light_wave 2>&1");
